...
void FullyConnected8(
  ...
  DMA_copy_W.number_of_2d_copies = 14;
  DMA_copy_W.number_of_1d_copies = 1;
  DMA_copy_W.dir = 1;
  DMA_copy_W.tid = dory_dma_channel;
  
  DMA_copy_y.hwc_to_chw = 0;
  DMA_copy_y.stride_2d = 56;
  DMA_copy_y.stride_1d = 56;
  DMA_copy_y.dir = 0;
  ...
  im2col = l1_buffer + 872;
  uint16_t out_shift = out_shift_in;

  ////////////////////////////
  // First tile transfering //
  ////////////////////////////
  DMA_copy_bias.ext = (uint32_t) l2_W+672;
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 816);
  DMA_copy_bias.number_of_2d_copies = 1;
  DMA_copy_bias.number_of_1d_copies = 1;
  DMA_copy_bias.length_1d_copy = (uint16_t) 56;
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      y_tile_size_nof = (_i_nof_load+1 == 1) ? 14 : 14;
      y_tile_size_byte = y_tile_size_nof*y_tile_size_h*y_tile_size_w*32/8;
      y_length_nof_byte = (_i_nof_load+1 == 1)   ? 56 : 56;
      W_tile_size_nof = (_i_nof_load+1 == 1) ? 14 : 14;
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 14, 1*1, 48, 1*1, 48, 0,0,0,0,0,0, 8);
        DMA_copy_W.loc = (l1_buffer + 120);
    ...
    b = (uint8_t *) (l1_buffer + 816 + _i_nof_load*56);
    W = (uint8_t *) (l1_buffer + 120);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 1, 1, 14, 1, 14, 0, 0, 0, 0, 0, 0, 32);
